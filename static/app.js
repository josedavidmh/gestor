                  ...
                  for (var i = 0; i < data.baul.length; i++) { 
                    ...
                    //  console.log(i,data.baul[i].clave)     
                     b+=`<tr><td>${data.baul[i].id_baul}</td><td>${data.baul[i].Plataforma}</td><td>${data.baul[i].usuario}</td><td>${data.baul[i].clave}</td>
                      <td><button type='button' class="btn btn-info" onclick="location.href = '/static/vistas/edit.html?variable1=${data.baul[i].id_baul}'"> <img src='/static/imagenes/edit.png' height ='30' width='30'/></button>
                      <button type='button' class="btn btn-warning" onclick="eliminar(${data.baul[i].id_baul})"> <img src='/static/imagenes/delete.png' height ='30' width='30'/></button></td></tr>`              
                    }
...
function consulta_individual(id){
 // alert(id)
  let url = "/consulta_individual/"+id;
